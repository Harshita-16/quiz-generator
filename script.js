let quiz = [
    {
        topic: 'MCU',
        difficulty: 'Beginner',
        question: 'How many Infinity Stones are there? (Beginner)',
        opt1: '4',
        opt2: '5',
        opt3: '6',
        opt4: '8',
    ...
    },
    {
        topic: 'MCU',
        difficulty: 'Beginner',
        question: 'Who was able to pick up Thor\'s hammer in Endgame? (Beginner)',
    ...
    {
        question: 'Which movie kicked off the MCU? (Intermediate)',
    ...
    {
        question: 'Who is the Winter Solider?(Advanced)',
        opt1: 'Steve Rogers',
        opt2: 'Hulk',
        opt3: 'Bucky',
        opt4: 'Loki',
    ...
    {
        question: 'Who is the first born of Odin?(Advanced)',
        opt1: 'Thor',
        opt2: 'Hela',
        opt3: 'Loki',
